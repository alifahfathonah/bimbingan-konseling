...
$sql = mysql_query("select * from data_siswa where id_siswa = '$sesi'") or die(mysql_error());
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <br>                                                
                        <center>
                        <img src="../assets/img/logoku.png" alt="" width="486" height="488" class="img-responsive" style="border-radius: 7%;">
