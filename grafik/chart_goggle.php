...
$satu =mysql_num_rows(mysql_query("SELECT * FROM setup_sosiometri WHERE nama_siswa='Zakiati Salma' "));
$dua =mysql_num_rows(mysql_query("SELECT * FROM setup_sosiometri WHERE nama_siswa='Riri fadilla' "));
?>
