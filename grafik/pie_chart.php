...
$jmlsiswa =mysql_num_rows(mysql_query("SELECT * FROM data_siswa"));
$laki =mysql_num_rows(mysql_query("SELECT * FROM data_siswa WHERE kelamin='Laki-laki' "));
$pr =mysql_num_rows(mysql_query("SELECT * FROM data_siswa WHERE kelamin='Perempuan' "));
 ?>
