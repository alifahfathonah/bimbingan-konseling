...
<a href="?page=siswa&action=edit&kdsis=<?php echo $data['id_siswa']; ?>" style="text-decoration: none;"><button class="btn btn-lg btn-info btn-block"><i class="fa fa-edit"></i> Ubah Data</button></a> <br>
<a href="?page=siswa&action=del&kdsis=<?php echo $data['id_siswa']; ?> " style="text-decoration: none;"><button class="btn btn-lg btn-danger btn-block"><i class="fa fa-times"></i> Hapus Data</button></button></a>  
 </div>