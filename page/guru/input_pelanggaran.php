...
<select name="nm_pelanggaran" class="form-control" onchange="changeValue(this.value)" >
	<?php
	$siswa=mysql_query("select * from setup_jenis_pelanggaran");
...
<?php 
include '../koneksi/-koneksi.php';
$nm_sanksi = mysql_query("SELECT nama_sanksi FROM setup_jenis_sanksi");
while($hasil = mysql_fetch_array($nm_sanksi)){
...
mysql_query("INSERT INTO tbl_siswa_pelanggaran VALUES ('id_pelanggaran','$nm_siswa','$nm_pelanggaran','$nm_sanksi','$poin','$tgl_kejadian','$ket')") or die(mysql_error());
?>
