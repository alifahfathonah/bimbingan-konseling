...
mysql_query("INSERT INTO setup_jenis_pelanggaran VALUES ('id_jenis','$nama_jenis','$point')") or die(mysql_error());
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    	    <?php
                                        include '../koneksi/-koneksi.php';
                                        $sql = mysql_query("select * from setup_jenis_pelanggaran") or die (mysql_error());
                                        $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<a onclick="return confirm('Yakin ingin hapus data ini ??')" href="?page=guru&action=del_jen&kdgr=<?php echo $data['id_jenis']; ?>">
