...
$guru =mysql_num_rows(mysql_query("SELECT * FROM data_guru"));
$siswa =mysql_num_rows(mysql_query("SELECT * FROM data_siswa"));
$kelas =mysql_num_rows(mysql_query("SELECT * FROM setup_kelas"));
$pelanggaran =mysql_num_rows(mysql_query("SELECT * FROM setup_jenis_pelanggaran"));
$sanksi =mysql_num_rows(mysql_query("SELECT * FROM setup_jenis_sanksi"));
?>
