...
mysql_query("INSERT INTO setup_sosiometri VALUES ('id_sosiometri','$nama_siswa','$teman1','$teman2','$alasan_teman','$bermain1','$bermain2','$alasan_bermain','$tidaksuka1','$tidaksuka2','$alasan_tidaksuka','$menyenangkan1','$menyenangkan2','$alasan_menyenangkan','$dukungan1','$dukungan2','$alasan_dukungan')") or die(mysql_error());
?>
