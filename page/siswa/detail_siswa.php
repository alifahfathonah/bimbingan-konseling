...
$sql_formulir = mysql_query("select * from data_siswa where id_siswa = '$sesi'") or die(mysql_error());
...
$sql_formulir = mysql_query("select * from data_orangtua where id_orangtua = '$sesi'") or die(mysql_error());
$data = mysql_fetch_array($sql_formulir);
?>
                     <tr>
...
$sql_formulir = mysql_query("select * from data_saudara where id_saudara = '$sesi'") or die(mysql_error());
$data = mysql_fetch_array($sql_formulir);
?>
                     <tr>
