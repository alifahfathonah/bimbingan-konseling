...
$siswa =mysql_num_rows(mysql_query("SELECT * FROM tbl_siswa_pelanggaran"));
$kelas =mysql_num_rows(mysql_query("SELECT * FROM tbl_siswa_pelanggaran"));
?>
...
<div class="col-lg-4">
            ...
            <div class="col-lg-4">
               ...
               <center>
                    ...
                    <h2><b>Aplikasi Bimbingan Konseling </b> <b></b> </h2>
                    <strong>SD N 095261 Simalungun </strong>
               </center>
