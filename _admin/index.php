...
$sql = mysql_query("select * from tb_admin where id_admin = '$sesi'") or die(mysql_error());
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <br>                                                
                        <center>
                        <img src="../assets/img/logoku.png" alt="" width="206" height="488" class="img-responsive" style="border-radius: 7%;">
                        </center>
                        <br>  
