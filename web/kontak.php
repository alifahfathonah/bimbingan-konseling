			...
			<h3 class="heading-agileinfo">Kontak Kami<span>SMKN 1 KEC.GUGUAK</span></h3>
			<div class="inner_sec_grids_info_w3ls">
				<div class="col-md-4 agile_info_mail_img_info">
					<div class="address-grid">
						<h4>Contact <span>Kami</span></h4>
						<div class="mail-agileits-w3layouts">
							<i class="fa fa-volume-control-phone" aria-hidden="true"></i>
							<div class="contact-right">
								<p>Telephone </p><span>0752-748337</span>
							</div>
						...
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<p>Mail </p><a href="smknegeri1guguak@gmail.com
   
">smknegeri1guguak@gmail.com
						...
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<p>Location</p><span>Jln. Kereta Api, Guguak VIII Koto.</span>
							</div>
							<div class="clearfix"> </div>
						</div>
